	...
	<div class="mx-auto max-w-7xl px-6">
		...
		>
			...
			<nav class="hidden space-x-10 md:flex">
				<div on:mousemove={()=>mouseenter(1)} on:mouseenter={()=>mouseenter(1)} on:mouseleave={()=>mouseleave(1)} class="relative">
					<button
						type="button"
					...
					>
						<div on:mousemove={()=>mouseenter(1)} on:mouseenter={()=>mouseenter(1)} on:mouseleave={()=>mouseleave(1)} class="{appear[1]?"":"hidden"} overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
				...
				<div on:mousemove={()=>mouseenter(2)} on:mouseenter={()=>mouseenter(2)} on:mouseleave={()=>mouseleave(2)} class="relative">
					...
					<div
                    on:mousemove={()=>mouseenter(2)} on:mouseenter={()=>mouseenter(2)} on:mouseleave={()=>mouseleave(2)} class="{appear[2]?"":"hidden"} absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0"
					>
